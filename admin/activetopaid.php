...
if($_POST['paid']=='Paid')
{
	...
	mysqli_query($conn,"insert into tbl_membership_user (paymentmode,activedate,plan_id,transaction_id,user_id) values ('".$paymentmode."','".$activedate."','".$plan_id."','".$transaction_id."','".$user_id."')");
	
	mysqli_query($conn,"update tbl_user set paid_status=1 where user_id='".$user_id."'");
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"> <a href="index.php">Active to Paid Member</a></h4>
                    </div>
                        ...
                        <div class="white-box" >
                           ...
                           <table  style="width:100%;">
							 ...
							 <th></th>
							  ...
							  <?php 
								$query=mysqli_query($conn,"select * from tbl_user where delete_status=0 and active=1 and paid_status!=1 ");
