...
/*if($_GET['type']=='approve')
{
	...
	{
		mysqli_query($conn,"update tbl_user set cover_image_approve='1' where user_id ='".$getid[$i]."'");
	}
	header("Location: coverimage.php");
...
if($_GET['type']=='unapprove')
{
	...
	for($i=0;$i<=count($getid);$i++)
	{
		mysqli_query($conn,"update tbl_user set cover_image_approve='0' where user_id ='".$getid[$i]."'");
	}
	header("Location: coverimage.php");
            ...
            <div class="container-fluid">
                <div class="row bg-title">
				   ...
				   <div class="row">
						 ...
						 <option value="10" selected="selected">select offer name</option>
						...
						<div class="form-group">
                                		<label>
                                    		<b>Select Offer Type</b>
                                   	 	</label>
                                    	<select class  ="form-control" name="state"  id="maxRows">						 
						 
						 <option value="10" selected="selected">select offer Type</option>
						 <option value="15"></option>
						 <option value="20"></option>
						 <option value="50"></option>
						 <option value="70"></option>						
                         <option value="5000"></option>
									...
									<div class="form-group">
									<a href="#" class="btn btn-custom btn-block waves-effect waves-light" style="width:80px;" > Add</a>
									</div>
									</div>
