            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"> <a href="index.php">Add SMS</a></h4>
                    </div>
                ...
                <form>	  
						...
						<div class="form-group">
                                       ...
                                       <option value="">Registration</option>
                                    	...
                                    	<option value="" >Profile Updation</option>
										<option value="">Deleted Profile</option>
                                    	<option value="" >Inactive</option>
										<option value="">Premium Activated</option>
                                    	<option value="" >Profile Verified</option>
										<option value="">Profile Approval</option>
                                    	<option value="" >Profile Unapproval</option>
                                        </select>
						...
						<textarea class="form-control" rows="10" col="100"name="about_myself" id="about_myself"></textarea>
				                ...
				                <a href="#" class="btn btn-custom btn-block waves-effect waves-light"  style="width:130px;height:36px"  onclick="active()"> Cancel</a>
