    ...
    <div id="wrapper">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"> <a href="index.php">Preview Notification</a></h4>
                    </div>
        ...
        <div class="num_rows">
				...
				<div class="form-group"> 	<!--		Show Numbers Of Rows 		-->
                 ...
                 <input style="padding: 5px;" type="date" id="start" name="trip-start">
                 <a href="#" class="btn btn-custom btn-block waves-effect waves-light"  style="width:130px;height:36px"  onclick="active()"> &nbsp Submit</a>
                         ...
                         <option value="5000">Short by Show ALL</option>
						   ...
						   <thead>
							  ...
							  <tr>
								...
								<td> name</td>
								<td> type</td>
								<td><a class="btn btn-custom btn-block waves-effect waves-light" data-toggle="collapse" style="width:130px" data-target="#indujual_2"> &nbsp Edit </a></div>
									<a class="btn btn-custom btn-block waves-effect waves-light" data-toggle="collapse" style="width:130px" data-target="#indujual_2"> &nbsp Delete </a></div>
				   <a class="btn btn-custom btn-block waves-effect waves-light" data-toggle="collapse" style="width:130px" data-target="#indujual_2"> &nbsp Disabled </a></div>
