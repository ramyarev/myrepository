...
if($_GET['action']=='active')
{
	...
	header('Location:horoscope_image.php');
...
<body>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"> <a href="index.php">Horoscope Images</a></h4>
                    </div>
				...
				<div >
				 ...
				 <a href="#" class="btn btn-custom_1 btn-block waves-effect waves-light" style="width:130px;height:36px"> <i class="fa fa-filter" aria-hidden="true"></i> &nbsp Filter Profile</a>
				  ...
				  <td>
				 <a href="#" class="btn btn-custom_1 btn-block waves-effect waves-light" style="width:130px;height:36px" onclick="approve()"> <i class="fa fa-thumbs-up" aria-hidden="true"></i> &nbsp Approve</a>
				 </td>
				 
				  <td>
				 <a href="#" class="btn btn-custom_1 btn-block waves-effect waves-light" style="width:130px;height:36px" onclick="unapprove()">  <i class="fa fa-thumbs-down" aria-hidden="true"></i>  &nbsp Un Approve</a>
				 </td>
				...
				?>
				 ...
				 <tr>
				  <td>
				 <a  class="btn btn-custom btn-block waves-effect waves-light"  style="width:130px;height:36px" data-toggle="collapse" data-target="#demo" onclick="active()">Active (<?php echo $activerowcount; ?>)</a>
				 </td>
				 <td>
				 <a class="btn btn-custom btn-block waves-effect waves-light" style="width:130px;height:36px" data-toggle="collapse" data-target="#demo_1" onclick="paid()">Paid (<?php echo $paidrowcount; ?>)</a>
				 </td>
				 
				  <td>
				 <a  class="btn btn-custom btn-block waves-effect waves-light" onclick="featured()"  style="width:150px;height:36px" data-toggle="collapse_2" data-target="#demo_2">Profile Highlighter (<?php echo $highlightercount; ?>)</a>
				 </td>
				 <td>
				 <a class="btn btn-custom btn-block waves-effect waves-light"  style="width:130px;height:36px"   data-toggle="collapse" data-target="#demo_3" onclick="inactive1()">In Active (<?php echo $inactiverowcount; ?>)</a>
				 </td>
				 <td>
				 <a class="btn btn-custom btn-block waves-effect waves-light" style="width:130px;height:36px" data-toggle="collapse" data-target="#demo_4" onclick="Suspended()">Suspended (<?php echo $suspendedrowcount; ?>)</a>
				 </td>
				 
				  <td>
				 <a  class="btn btn-custom btn-block waves-effect waves-light" style="width:130px;height:36px" data-toggle="collapse" data-target="#demo_5" onclick="all()">All (<?php echo $rowcount; ?>)</a>
				 </td>
				  <td>
				 <a  class="btn btn-custom btn-block waves-effect waves-light" style="width:130px;height:36px" data-toggle="collapse" data-target="#demo_5" onclick="all()">Premium (<?php echo $premiumcount; ?>)</a>
				 </td>
				 </tr>
				 </table>
				   ...
				   <div style="overflow-x:auto;">
                        <div class="white-box" >
                           ...
                           <table  style="width:100%;">
							 ...
							 <th></th>
							  ...
							  <?php 
								...
								<img src="../uploads/horoscope/<?php echo $fetchdata['horoscope']; ?>" width="150" height="150">
								<?php } else { ?>
						 ...
						 <a href="horoscope_image.php?type=approve&id=<?php echo $fetchdata['user_id'] ?>" class="btn btn-block waves-effect waves-light"style="border:1px solid #337ab7;width:150px;" ><i class="fa fa-user-plus" aria-hidden="true"></i> &nbsp Horoscope Images &nbsp</i>
								...
								<td colspan="2" style="color:#767676;font-size:21px;border:0px solid #dddddd;text-transform: uppercase;">
								...
								if($fetchdata['horoscope_approve']==1)
								{
									echo "Approve";
								}
								else { echo "Un Approve"; }
								?>
								</td>
								</tr>
	...
	$todaydata=mysqli_query($conn,"SELECT * FROM tbl_user WHERE (gender = (select gender from tbl_partners WHERE user_id='".$user_id."') or (age >= (select min_age from tbl_partners WHERE user_id='".$user_id."') and age <= (select max_age from tbl_partners WHERE user_id='".$user_id."')) or ( feet_inch >= (select min_feet_inch from tbl_partners WHERE user_id='".$user_id."') and feet_inch <= (select max_feet_inch from tbl_partners WHERE user_id='".$user_id."')) or ( weight >= (select min_weight from tbl_partners WHERE user_id='".$user_id."')  and weight <= (select max_weight from tbl_partners WHERE user_id='".$user_id."')) or caste = (select caste from tbl_partners WHERE user_id='".$user_id."') or sub_caste = (select sub_caste from tbl_partners WHERE user_id='".$user_id."') or marital_status = (select marital_status  from tbl_partners WHERE user_id='".$user_id."') or mother_tongue = (select mother_tongue  from tbl_partners WHERE user_id='".$user_id."') or raasi = (select raasi  from tbl_partners WHERE user_id='".$user_id."') or star = (select natchathiram  from tbl_partners WHERE user_id='".$user_id."') or having_dosham = (select having_dosham  from tbl_partners WHERE user_id='".$user_id."') or dosham_details = (select dosham  from tbl_partners WHERE user_id='".$user_id."') or occupation = (select profession  from tbl_partners WHERE user_id='".$user_id."') or physical_status = (select physical_status  from tbl_partners WHERE user_id='".$user_id."') or nationality = (select nationality  from tbl_partners WHERE user_id='".$user_id."') or  country = (select country  from tbl_partners WHERE user_id='".$user_id."') or home_city = (select preferred_cities  from tbl_partners WHERE user_id='".$user_id."') or paadham = (select paadham  from tbl_partners WHERE user_id='".$user_id."') or ( min_income >= (select min_income from tbl_partners WHERE user_id='".$user_id."') and max_income <= (select max_income from tbl_partners WHERE user_id='".$user_id."')) or education = (select education  from tbl_partners WHERE user_id='".$user_id."') or  state = (select state from tbl_partners WHERE user_id='".$user_id."') ) and min_income!='' and max_income !='' and weight!='' and feet_inch!='' and age!=0 and user_id!='".$user_id."' and delete_status=0 and gender!='".$gender."' and DATE(profile_created_by) = CURDATE() order by profile_created_by desc");
