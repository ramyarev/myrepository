...
if($_GET['type']=='approve')
{
	...
	{
		mysqli_query($conn,"update tbl_user set id_proof_approve='1' where user_id ='".$getid[$i]."'");
	}
	header("Location: idproof.php");
...
if($_GET['type']=='unapprove')
{
	...
	for($i=0;$i<=count($getid);$i++)
	{
		mysqli_query($conn,"update tbl_user set id_proof_approve='0' where user_id ='".$getid[$i]."'");
	}
	header("Location: idproof.php");
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"> <a href="index.php">Id Proof</a></h4>
                    </div>
					...
					<div class="col-sm-12">			
						...
						<table  id="member" class="display" style="width:100%">
							  ...
							  <tr>
								...
								<?php if($fetchdata['id_proof_approve']==1) { ?>
