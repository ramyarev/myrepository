 ...
 <div class="preloader">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <?php include('header.php') ?>        <!-- /.dropdown -->
                    <li class="dropdown">
                         ...
                         <option value="5000">Short by Show ALL</option>
						   ...
						   <thead>
							  <tr>
								...
								<th>Image</th>
								<th>Promocode</th>
								<th>Short Descriptive</th>
								<th>Long Descriptive</th>								
								<th>Type</th>
								<th>Type of Mode</th>
								<th>SMS</th>
								<th>User Details</th>
							  ...
							  <tr>
								...
								<td>011:00 PM</td>
								<td>Offer name</td>
								<td>Offer Plan name</td>
								<td><img src="../uploads/profile_image/images.jpg" width="100" height="100" class="thumbnail zoom"></td>
								<td>124587</td>
								<td>text</td>
								<td>text</td>
								<td>Group <br> <a href="group.php">View</a></td>								
								<td>SMS</td>
								<td>250</td>
								<td>Paid</td>
								<td>Hi</td>
