...
if($_GET['activeid']!='')
{
	mysqli_query($conn,"update tbl_user set active='1' where user_id ='".$_GET['activeid']."'");
...
<body>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"> <a href="index.php">Profile Active Member</a></h4>
                    </div>
                        ...
                        <div class="white-box" >
                           ...
                           <table  style="width:100%;">
							 ...
							 <th></th>
							  ...
							  <?php 
								$query=mysqli_query($conn,"select * from tbl_user where delete_status=0 and active=0");		
	...
	.top-left {
	  ...
	  transform:rotate(-90deg);
						  ...
						  <tr>
						  <td>
						<a href="profile_active.php?activeid=<?php echo $fetchdata['user_id'];?>" class="btn btn-block waves-effect waves-light"style="border:1px solid #337ab7;" ><i class="fa fa-thumbs-o-up"  aria-hidden="true" data-toggle="modal" data-target="#myModal_5"> &nbsp Plan approved</i>
								</td>
