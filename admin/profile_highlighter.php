...
if($_GET['action']=='active')
{
	...
	header('Location:profile_highlighter.php');
...
<body>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"> <a href="index.php">Profile Highlighter</a></h4>
                    </div>
	...
	.top-left {
	  ...
	  transform:rotate(-90deg);
						  ...
						  <tr>
						  <td>
						 <a href="javascript:void(0)" class="btn btn-block waves-effect waves-light"style="border:1px solid #337ab7;" ><i class="fa fa-user-plus" aria-hidden="true"></i> &nbsp Profile Highlighter</i>
								</td>
