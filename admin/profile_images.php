...
if($_GET['action']=='active')
{
	...
	header('Location:profile_images.php');
...
if($_GET['type']=='approve')
{
	...
	for($i=0;$i<=count($getid);$i++)
	{
		mysqli_query($conn,"update tbl_user set profile_image_approve='1' where user_id ='".$getid[$i]."'");
	}
	header("Location: profile_images.php");
...
if($_GET['type']=='unapprove')
{
	...
	for($i=0;$i<=count($getid);$i++)
	{
		mysqli_query($conn,"update tbl_user set profile_image_approve='0' where user_id ='".$getid[$i]."'");
	}
	header("Location: profile_images.php");
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"> <a href="index.php">Profile Images</a></h4>
                    </div>
				 ...
				 <a  href="#"  class="btn btn-custom btn-block waves-effect waves-light" style="width:130px;height:36px" data-toggle="collapse" data-target="#demo_5" >Premium (<?php echo $premiumcount; ?>)</a>
				   ...
				   <div style="overflow-x:auto;">
                        <div class="white-box" >
						 ...
						 <a href="profile_images.php?type=approve&id=<?php echo $fetchdata['user_id'] ?>" class="btn btn-block waves-effect waves-light"style="border:1px solid #337ab7;width:150px;" ><i class="fa fa-user-plus" aria-hidden="true"></i> &nbsp Profile Images</i>
								...
								if($fetchdata['profile_image_approve']==1)
								{
									echo "Approve";
								}
