...
if($_GET['action']=='active')
{
	...
	header('Location:recentmember.php');
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"> <a href="index.php">Recent Member</a></h4>
                    </div>
                        ...
                        <div class="white-box" >
                           ...
                           <table  style="width:100%;">
							 ...
							 <th></th>
							  ...
							  <?php 
								$query=mysqli_query($conn,"select * from tbl_user where delete_status=0 and profile_created_by >= DATE_SUB(CURDATE(), INTERVAL 30 DAY) order by profile_created_by desc");	
