...
if($_GET['action']=='active')
{
	...
	header('Location:renew_member.php');
...
<body>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"> <a href="index.php">Renew Member</a></h4>
                    </div>
							 ...
							 <th></th>
							  ...
							  <?php 
								...
								while($fetchdata=mysqli_fetch_array($query))
								{
									...
									$getactivedate=mysqli_fetch_array(mysqli_query($conn,"select * from tbl_membership_user where status=0 and user_id='".$fetchdata['user_id']."' "));		

									$getplanfeature=mysqli_query($conn,"select * from tbl_plan_feature where plan_id='".$getactivedate['plan_id']."'");
									$fetchplanfeature=mysqli_fetch_array($getplanfeature);

									$duration=$fetchplanfeature['default_duration'];
									
									$activedate=$getactivedate['activedate'];
	...
	.top-left {
	  ...
	  transform:rotate(-90deg);
						 ...
						 <a href="javascript:void(0)" onclick="openmodal('<?php echo $fetchdata['user_id'] ?>')" class="btn btn-block waves-effect waves-light"style="border:1px solid #337ab7;"  id="myBtn" data-toggle="modal" data-target="#myModal"><i class="fa fa-user-plus" aria-hidden="true"></i> &nbsp Renew Member</i>
								</td>
								
								</tr>
								<tr>
								<td>
								<b style="color:red"><?php echo $next_due_date;?> </b>
								</td>
								</tr>
								</table>
