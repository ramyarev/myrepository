...
if($_POST['paid']=='Paid')
{
	...
	mysqli_query($conn,"update tbl_membership_user set activedate='".$activedate."',plan_id='".$plan_id."' where user_id='".$user_id."' and status=0");
	
	
	header('Location:updownmember.php');
}
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"> <a href="index.php">Up/Down Grade Member Plan</a></h4>
                    </div>
