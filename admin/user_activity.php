            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"> <a href="index.php">USer Activity</a></h4>
                    </div>
				...
				<div class="col-lg-6 col-sm-8 col-md-8 col-xs-12"> <!--a href="https://themeforest.net/item/elite-admin-responsive-dashboard-web-app-kit-/16750820" target="_blank" class="btn btn-danger pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Buy Now</a-->
                        <ol>
                            <form role="search" class="">
                            <input type="text" placeholder="Search by ID/Cell Number..." class="form-control"></div>
                     <div class="col-lg-6">
