            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"> <a href="index.php">View Coupons</a></h4>
                    </div>
                   ...
                   <div class="col-sm-12">
                        ...
                        <div class="white-box" class="col-sm-12">
						   ...
						   <thead>
							  ...
							  <tbody>
							  <?php  $query=mysqli_query($conn,"select * from tbl_promocode_histrory where promocode='".$_GET['code']."'"); 
							  while($getdata=mysqli_fetch_array($query))
							  {
								  $fetchuser=mysqli_fetch_array(mysqli_query($conn,"select * from tbl_user where user_id='".$getdata['user_id']."'"));
							  ?>
							  <tr>
								
								<td><?php echo $getdata['orderid']; ?></td>
								<td><?php echo $fetchuser['name']; ?></td>
								<td><?php echo $getdata['total_amount']; ?></td>
								<td><?php echo $getdata['date_added']; ?></td>
								</tr>
							  <?php } ?>
							  </tbody>
							</table>
